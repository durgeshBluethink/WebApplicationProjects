<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminManageJobPost.aspx.cs" Inherits="WebApplicationProject.AdminModule.AdminManageJobPost" %>
                ...
                <asp:GridView ID="gvjobpost" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="WorkingMode">
                            <ItemTemplate>
                                <%#Eval("JobPostMode").ToString() == "1" ? "Work From Office" : Eval("JobPostMode").ToString() == "2" ? "WorkFromHome" : "Hybrid Mode"%>
                            </ItemTemplate>
                        </asp:TemplateField>
